...
module RpmsRpc
  # Real IHS **CIA** broker client — the `{CIA}` protocol served by CIANBLIS, which
  # VueCentric / RPMS-EHR speak. (The existing RpmsRpc::CiaClient actually implements
  # the stock XWB `[XWB]1130` / XWBTCPM protocol despite its name and should be renamed
  # XwbClient; THIS is the genuine CIA client.)
  #
